namespace Fhir.Fluid.Converter.Benchmark.Benchmarks
{
    ...
    {
        public const string SampleDataPath = @"C:\work\FluidCdaTest\data\SampleData\";
        public const string DevTemplatesPath = @"C:\work\FluidCdaTest\FluidCdaTest.Benchmark\DevBranchTemplates\Ccda";
